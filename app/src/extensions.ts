...
export function registerExtensions(app: App): void {
	...
	const { registeredModules, onHydrateModule, onDehydrateModule } = registerModules(modules);
	...
	onHydrateFns.push(onHydrateModule);
	onDehydrateFns.push(onDehydrateModule);
}
